...
parser.add_argument('-r', '--convert_variant', action='store_false')
...
with open(args.file, 'rt') as file_read, open(f'{filename}-converted{file_ext}', 'wt') as file_write:
    file_write.write(convert(file_read.read(), use_supp_planes=args.use_supp_planes, use_j=args.use_j, use_k=args.use_k, convert_variant=args.convert_variant))